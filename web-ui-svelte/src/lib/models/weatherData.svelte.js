export class WeatherData {
    ...
    initializeData(initialData) {
        ...
        this.#weatherData.timestamp = initialData.updatedTimestamp ? new Date(initialData.updatedTimestamp) : new Date();
    ...
    update (messageContainer) {
        if (messageContainer.category === "WeatherData" && messageContainer.isStreaming) {
            this.#weatherData.timestamp = new Date(messageContainer.timestamp);
            ...
            console.error("Unexpected message category or streaming state for weather data: ", messageContainer.category, messageContainer.isStreaming);
        }
    }
}